...
// Query: *[    _type == "resourcePage" ||     _type == "post" ||     _type == "aboutPage" ||    _type == "contactPage" ||    _type == "homePageSingleton"  ] | order(_type asc) {    _type == "homePageSingleton" => {      "slug": "",      "_type": _type,      "_updatedAt": _updatedAt    },    _type == "aboutPage" => {      "slug": "about",      "_type": _type,      "_updatedAt": _updatedAt    },    _type == "contactPage" => {      "slug": "contact",      "_type": _type,      "_updatedAt": _updatedAt    },    _type in ["resourcePage", "post"] => {      "slug": slug.current,      "_type": _type,      "_updatedAt": _updatedAt    }  }
