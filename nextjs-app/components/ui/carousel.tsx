      ...
      {[...Array(slideCount)].map((_, index) => (
        <button
          ...
          className={cn(
            ...
            "hover:bg-primary/5 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none",
...
function CarouselCounter({
  ...
  return (
    <div
      className={cn(
        "mt-4 flex justify-center text-sm text-muted-foreground",
        className
      )}
      {...props}
    >
